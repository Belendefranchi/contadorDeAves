...
$result = mysqli_query($connString, " SELECT MAX(tiempo), lote, patente, MAX(valor) FROM valores WHERE (DATE(fecha) = '$fecha') GROUP BY lote ") or die("database error:". mysqli_error($connString));
